...
begin
  ...
  on conflict (cle) do update set compteur = public.quota_reservations_publiques.compteur + 1
...
comment on function public.consommer_quota_reservation(text, integer) is 'Quota serveur atomique réservé à la passerelle de dépôt public.';