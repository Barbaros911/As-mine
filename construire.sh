...
rm -rf site
mkdir -p site
cp index.html admin.html admin-v2.html admin-v2-actions.js admin-v2-push.js admin-v2-finance.js manifest.webmanifest sw.js \
...
for script in ('/admin-v2-actions.js','/admin-v2-push.js','/admin-v2-finance.js'):
