...
rm -rf site
mkdir -p site
cp index.html admin.html admin-v2.html admin-v2-responsive.css admin-v2-actions.js admin-v2-itineraire.js admin-v2-push.js admin-v2-finance.js admin-v2-registre.js admin-v2-factures.js admin-v2-gestes.js admin-v2-affiche.js admin-v2-maquette.js intake-demande.js qr-affiche.js manifest.webmanifest sw.js \
...
style='<link rel="stylesheet" href="/admin-v2-responsive.css">'
if style not in a:a=a.replace('</head>',style+'</head>',1)
for script in ('/intake-demande.js','/qr-affiche.js','/admin-v2-actions.js','/admin-v2-itineraire.js','/admin-v2-push.js','/admin-v2-finance.js','/admin-v2-registre.js','/admin-v2-factures.js','/admin-v2-gestes.js','/admin-v2-affiche.js','/admin-v2-maquette.js'):
