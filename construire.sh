...
rm -rf site
mkdir -p site
cp index.html admin.html admin-v2.html admin-v2-actions.js admin-v2-push.js admin-v2-finance.js admin-v2-registre.js admin-v2-factures.js admin-v2-gestes.js intake-demande.js manifest.webmanifest sw.js \
...
for script in ('/intake-demande.js','/admin-v2-actions.js','/admin-v2-push.js','/admin-v2-finance.js','/admin-v2-registre.js','/admin-v2-factures.js','/admin-v2-gestes.js'):
