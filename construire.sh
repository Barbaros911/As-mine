...
rm -rf site
mkdir -p site
cp index.html admin.html admin-v2.html admin-v2-actions.js admin-v2-itineraire.js admin-v2-push.js admin-v2-finance.js admin-v2-registre.js admin-v2-factures.js admin-v2-gestes.js admin-v2-affiche.js intake-demande.js qr-affiche.js itineraire-partage.js manifest.webmanifest sw.js \
...
for script in ('/intake-demande.js','/qr-affiche.js','/itineraire-partage.js','/admin-v2-actions.js','/admin-v2-itineraire.js','/admin-v2-push.js','/admin-v2-finance.js','/admin-v2-registre.js','/admin-v2-factures.js','/admin-v2-gestes.js','/admin-v2-affiche.js'):
...
>>>>>>> 1e47c4f (Brique 7 (1/2) : la chaîne du prix déménage dans itineraire-partage.js)
